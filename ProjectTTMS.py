...
#Connecting Database
'''connection =pyodbc.connect('Driver={SQL Server};' 'Server=localhost\\SQLExpress;'
'Database=projectTTMS;' 'Trusted_connection=yes;')'''
#connection = pyodbc.connect(driver='{SQL Server}', host=localhost, database=projectTTMS,
                    #  trusted_connection=tcon, user=root, password=Ns@1311)
connection_string= (
"Driver={SQL Server};"
"Server=localhost\\SQLExpress,3306;"  # Specify the port number after the instance name
